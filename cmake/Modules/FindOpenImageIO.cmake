...
#
#  OPENIMAGEIO_INCLUDE_DIRS - where to find OpenImageIO includes.
...
if (NOT WIN32)
  ...
  GET_FILENAME_COMPONENT(OIIO_PARENT ${OPENIMAGEIO_INCLUDE_DIR} PATH)
  message("Windows PARENT DIR: ${OIIO_PARENT}")
  FIND_LIBRARY(OPENIMAGEIO_LIBRARY NAMES OpenImageIO.lib HINTS ${OIIO_PARENT}/lib/x64)
endif()  
