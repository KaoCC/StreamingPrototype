...
namespace SP {
	...
	void PtRenderer::generateDepthRays(const Scene& scene, size_t camIdx) {
		const std::size_t imageWidth = renderOutPtr->getWidth();
		const std::size_t imageHeight = renderOutPtr->getHeight();
